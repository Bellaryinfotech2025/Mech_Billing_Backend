...
public class OrderFabricationDetailDTO {
    ...
    private String lengthUomMeaning;
    private BigDecimal quantity;
    private BigDecimal unitPrice;
    private String unitPriceUom;
    private String unitPriceUomMeaning;
    private BigDecimal totalQuantity;
    private String totalQuantityUom;
    private String totalQuantityUomMeaning;
    ...
    public String getLengthUomMeaning() {
        return lengthUomMeaning;
    }

    public void setLengthUomMeaning(String lengthUomMeaning) {
        this.lengthUomMeaning = lengthUomMeaning;
    }
    ...
    public String getUnitPriceUomMeaning() {
        return unitPriceUomMeaning;
    }

    public void setUnitPriceUomMeaning(String unitPriceUomMeaning) {
        this.unitPriceUomMeaning = unitPriceUomMeaning;
    }
    ...
    public String getTotalQuantityUomMeaning() {
        return totalQuantityUomMeaning;
    }

    public void setTotalQuantityUomMeaning(String totalQuantityUomMeaning) {
        this.totalQuantityUomMeaning = totalQuantityUomMeaning;
    }
