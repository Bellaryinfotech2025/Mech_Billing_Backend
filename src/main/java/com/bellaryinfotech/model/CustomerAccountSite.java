...
public class CustomerAccountSite {
    ...
    @Column(name = "payment_terms", length = 45)
    ...
    @Column(name = "site_number", length = 250)
    ...
    @Column(name = "location_attr1", length = 150)
    private String locationAttr1;

    @Column(name = "location_attr2", length = 150)
    private String locationAttr2;
	...
	public String getLocationAttr1() {
		return locationAttr1;
	}

	public void setLocationAttr1(String locationAttr1) {
		this.locationAttr1 = locationAttr1;
	}

	public String getLocationAttr2() {
		return locationAttr2;
	}

	public void setLocationAttr2(String locationAttr2) {
		this.locationAttr2 = locationAttr2;
	}
